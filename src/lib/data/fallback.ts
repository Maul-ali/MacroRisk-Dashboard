...
export const FALLBACK_NEWS: NewsArticle[] = [
  {
    ...
    source: 'UN News',
    sourceUrl: 'https://news.un.org/en/story/2024/01/1145402',
  ...
  },
  {
    ...
    source: 'UN News',
    sourceUrl: 'https://news.un.org/en/story/2024/04/1148566',
  ...
  },
  {
    ...
    source: 'EIA',
    sourceUrl: 'https://www.eia.gov/todayinenergy/detail.php?id=61384',
  ...
  },
  {
    ...
    source: 'EIA',
    sourceUrl: 'https://www.eia.gov/todayinenergy/detail.php?id=61724',
  ...
  },
  {
    ...
    source: 'UN News',
    sourceUrl: 'https://news.un.org/en/story/2024/05/1149726',
  ...
  },
  {
    ...
    source: 'EIA',
    sourceUrl: 'https://www.eia.gov/todayinenergy/detail.php?id=61964',
